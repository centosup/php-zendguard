...
install -D -pm 755 ZendGuardLoader-php-5.3-linux-glibc23-x86_64/php-5.3.x/ZendGuardLoader.so %{buildroot}%{php_extdir}/%{extname}.so
...
%files
%defattr(-,root,root,-)
%doc ZendGuardLoader-php-5.3-linux-glibc23-x86_64/*.txt
